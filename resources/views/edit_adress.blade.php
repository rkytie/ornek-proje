        ...
        <div class="row justify-content-md-center">
            <div class="col-lg-6">
                <div class="card"
                    ...
                    <div class="col-lg-12">
                        <form action="{{ route('updateAdress') }}" method="post" class="row g-3 address-form">
                            @csrf
                            <input type="hidden" value="{{ $adress->id }}" name="id">
                            <div class="col-md-12">
                                <label for="inputFirstName" class="form-label">@lang('app.adres_basligi')
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea type="text" required name="adress" class="form-control" value="{{ $adress->adress }}">{{ $adress->adress }}</textarea>
                            </div>
