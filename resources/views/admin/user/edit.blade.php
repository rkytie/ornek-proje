            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" class="needs-validation" novalidate
                        action="{{ route('admin.users.update', ['user' => $user->id]) }}" autocomplete="off"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control" name="permission" id="permission" required>
                                        ...
                                        <option value="2" @if ($user->permission == 2) selected @endif>Yönetici</option>
                                        <option value="3" @if ($user->permission == 3) selected @endif>Personel</option>
                                    </select>
