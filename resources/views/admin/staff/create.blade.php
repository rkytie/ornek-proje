...
@section('title') Yeni Personel @endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" class="needs-validation" novalidate action="{{ route('admin.staffs.store') }}"
                                ...
                                <div class="form-group mb-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="created_date"
                                            value="{{ date('Y-m-d') }}"  name="created_date"
                                            required>
                                ...
                                <div class="form-group mb-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="started_at"
                                            value="{{ date('Y-m-d') }}" name="started_at"
                                            required>
                                        <div class="invalid-feedback">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    <div class="mb-3">
                                        ...
                                        <input disabled type="date" class="form-control" id="finished_at"
                                            value="{{ date('Y-m-d') }}" name="finished_at"
                                            required>
                                        <div class="invalid-feedback">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="work" id="work" required>
                                    <div class="invalid-feedback">
