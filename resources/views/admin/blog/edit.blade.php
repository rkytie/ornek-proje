            ...
            <div class="card">
                <div class="card-body">
                    <form method="post" class="needs-validation" novalidate
                        action="{{ route('admin.blogs.update', ['blog' => $blog->id]) }}" autocomplete="off"
                        ...
                        <section>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="slug" value="{{ $blog->slug }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="form-group">
                                    <textarea class="ckeditor form-control" id="content" name="content">{{ $blog->content }}</textarea>
                                </div>
                                <div class="invalid-feedback">
