...
@section('title') Yeni Banka @endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" class="needs-validation" novalidate action="{{ route('admin.banks.store') }}"
                        ...
                        <section>
                            ...
                            <div class="form-group mb-3">
                                <label class="mb-2" for="photo">Fotoğraf (112x68)</label>
