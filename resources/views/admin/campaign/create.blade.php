...
@section('title') Yeni Kampanya @endsection

@section('content')
    <!-- start page title -->
    @include('includes.page-title-box',[
    'pageTitle'=>"Kampanya Ekle",
    ])
    <!-- end page title -->
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" class="needs-validation" novalidate action="{{ route('admin.campaigns.store') }}"
                        ...
                        <section>
                            ...
                            <div class="form-group mb-3">
                                <label class="mb-2" for="photo">Fotoğraf (545x250)</label>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="invalid-feedback">
                                    Lütfen geçerli bir link giriniz.
                                </div>
                            </div>
                            <div class="form-group mb-3">
                                <label class="mb-2" for="ordering">Sıra</label>
                                <input type="number" class="form-control" id="ordering" value="{{ old('ordering') }}"
