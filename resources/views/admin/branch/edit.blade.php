...
@section('title') {{ $branch->name }} @endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" class="needs-validation" novalidate action="{{ route('admin.branchs.update',['branch'=>$branch->id]) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select name="type" class="form-control" id="type">
                                    ...
                                    <option value="0" @if($branch->type==0) selected @endif >Hayır</option>
                                    <option value="1"  @if($branch->type==1) selected @endif>Evet</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                        ...
                        <section>
                            ...
                            <x-form.edit-address :address="$branch" />
                        </section>
                        ...
                        <section>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="email" class="form-control" id="email" value="{{  $branch->email  }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="tel" class="form-control" id="phone" value="{{ $branch->phone  }}"
