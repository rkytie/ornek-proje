...
@section('title') Yeni İndirim @endsection

@section('content')
    <!-- start page title -->
    @include('includes.page-title-box',[
    'pageTitle'=>"İndirim Ekle",
    ])
    <!-- end page title -->
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" class="needs-validation" novalidate action="{{ route('admin.discounts.store') }}"
                        ...
                        <section>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="link" value="{{ old('link') }}"
                                    placeholder="Ad" name="link" required>
                                <div class="invalid-feedback">
                                    Lütfen geçerli bir isim giriniz.
                                </div>
                            </div>
                            <div class="form-group mb-3">
                                <label class="mb-2" for="photo">Fotoğraf (610x300)</label>
