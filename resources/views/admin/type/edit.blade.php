...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" class="needs-validation" novalidate action="{{ route('admin.types.update', ['type' => $type->id]) }}"
                        ...
                        <section>
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="name" value="{{ $type->name }}"
