...
@section('title') Pencere Özellikleri Ekle @endsection

@section('content')
    <!-- start page title -->
    @include('includes.page-title-box',[
    'pageTitle'=>"Pencere Özellikleri Ekle",
    ])
    <!-- end page title -->
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" class="needs-validation" novalidate action="{{ route('admin.glass-features.store', ['glass_features' => $glass_feature->id]) }}"
