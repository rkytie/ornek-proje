...
<div class="container mt-5 mb-5">
  <div class="row justify-content-md-center">
    ...
    display: block;" style="font-size: 14px;
    font-weight: 600;
    display: block;">@lang('app.parola') <span class="required">*</span></label>
    ...
    display: block;">@lang('app.parola_tekrari') <span class="required">*</span></label>
              <input type="password" required  name="password_confirmation" class="form-control" id="inputPasswordConfirm">
    ...
    border-color: #00448e;" class="btn btn-primary">
            ...
            <p>Är du medlem? <a style="color:#064890" href="{{ route('giris') }}"><em>Logga in</em></a></p>
